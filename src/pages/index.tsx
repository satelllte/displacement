      ...
      <div className='md:flex'>
        ...
        <section className='mt-16 h-[calc(100vh-theme(spacing.16))] relative md:flex-1'>
          <div className='absolute inset-4 flex flex-col justify-between'>
            ...
            <button className='p-4 w-full bg-neutral-800/50 hover:bg-neutral-800/75 active:bg-neutral-800 transition-all outline outline-2 outline-transparent focus:outline-neutral-800'>Render</button>
          </div>
        </section>
      </div>
    </>
