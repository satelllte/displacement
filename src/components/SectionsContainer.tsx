  ...
  return (
    <SectionsContainerContext.Provider value={{
      ...
      <div className='absolute inset-0 flex justify-between flex-col md:flex-row'>
        ...
        <div className={`fixed bg-black/75 inset-x-0 h-4/5 drop-shadow-xl md:drop-shadow-none transition-transform ease-out-quad duration-500 ${secondarySectionOpened ? '-translate-y-full' : ''} md:-translate-y-full top-full md:h-auto md:flex-1 md:relative box-border border-t md:border-l md:border-t-0 border-Xborder`}>
          {secondary}
        </div>
